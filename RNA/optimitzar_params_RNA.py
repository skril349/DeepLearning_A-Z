...
# millorant RNA
#grid search prova múltiples valors d'hiperparàmetres per tal de trobar els millors valors
...
def buildClassifier(optimizer = "adam"):
    # inicialitzem la xarxa neuronal artifical RNA
    classifier = Sequential()
    classifier.add(Dense(units=6, kernel_initializer="uniform",
                         activation="relu", input_dim=11))
...
print("best_score = ",best_accuracy)